    ...
    <SidebarProvider defaultOpen={false}>
      <div className="min-h-screen flex w-full bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 transition-colors duration-300">
        ...
        <SidebarInset className="flex-1 ml-0">
          <header className="flex h-10 shrink-0 items-center gap-2 border-b border-gray-200 dark:border-gray-700 bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl px-4">
          ...
          <main className="flex-1 p-3 bg-gray-50/50 dark:bg-gray-900/50 transition-colors duration-300">
