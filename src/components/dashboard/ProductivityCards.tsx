  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-2 mb-1">
      ...
      <div className="bg-white rounded-md shadow-sm border border-gray-200 p-3">
        ...
        <p className="text-xl font-bold text-green-600">{weekSessions}</p>
      ...
      <div className="bg-white rounded-md shadow-sm border border-gray-200 p-3">
        ...
        <p className="text-xl font-bold text-purple-600">{pendingSessions}</p>
      ...
      <div className="bg-white rounded-md shadow-sm border border-gray-200 p-3">
        ...
        <p className="text-xl font-bold text-orange-600">{pendingStudents}</p>
      ...
      <div className="bg-white rounded-md shadow-sm border border-gray-200 p-3">
        ...
        <p className="text-xl font-bold text-red-600">{studentsWithDelayedTasks}</p>
